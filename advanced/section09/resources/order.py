...
class Order(Resource):
    ...
    def post(cls):
        ...
        for _id, count in item_id_quantities.most_common():
            # most_common() gives you all of the items with how many times they happen
            # if you want top 3, pass 3 as parameter -> common(3)
        ...
        try:
            ...
            return order.charge_with_stripe(data["token"])
